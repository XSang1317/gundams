...
<section id="main-content">
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright" align="right">
			  <p>Copyright 2021 © by <a target="_blank" href="https://www.facebook.com/Kids1317">Xuân Sang</a></p>
			</div>
		  </div>
  <!-- / footer -->
</section>
...
{{-- <script>
    function previewFile(input){
        var file = $(".image-preview").get(0).file[0];
        console.log(file);
        if(file){
