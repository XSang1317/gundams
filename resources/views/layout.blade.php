...
<head>
    ...
    <link rel="icon" href="{{asset('public/frontend/images/Gundam-z.png')}}" type="image/gif" sizes="32x32">
...
<body>
    ...
    <header id="header"><!--header-->
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <div class="contactinfo">
                            <ul class="nav nav-pills" style="align-content: right">
                                <li><a href="#"><i class="fa fa-phone"></i><span style="color:red"> Hotline:</span> 0934101207 - Sang Bùi</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> xsang1317@gmail.com</a></li>
        ...
        <div class="header-middle"><!--header-middle-->
            ...
            <div class="container">
                ...
                <div class="row">
                    <a href="{{URL::to('/trang-chu')}}"><img src="https://e7.pngegg.com/pngimages/970/289/png-clipart-multicolored-illustration-gundam-model-art-logo-logos-emblem-illustrator.png" alt="" width="50px" height="50px"/></a>
                    <div class="col-sm-4">
                ...
                <div class="row">
                    <div class="col-sm-7">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="{{URL::to('/trang-chu')}}">{{__('lang.product')}}<i class="fa fa-angle-down"></i></a>
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="search_box">
                            ...
                            <input type="text" style="width: 60%;margin-right: 5px; font-size: 13px" name="keywords_submit" id="keywords" placeholder="Tìm kiếm sản phẩm"/>
    ...
    <footer id="footer"><!--Footer-->
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-right">Gundam-Z Copyright © 2021 by <a href="https://www.facebook.com/Kids1317">XuanSang</a></p>
